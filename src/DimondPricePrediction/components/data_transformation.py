...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join('artifacts','preprocessor.pkl') # storing pickle file
...
class DataTransformation:
    ...
    # complete preprocessing data is written here
    ...
    def initialize_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            input_feature_train_df = train_df.drop(columns=drop_columns,axis=1) # training feature
            ...
            logging.info("Exception occured in the initialize_datatransformation")
            raise customexception(e,sys)